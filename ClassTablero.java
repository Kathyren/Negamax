...
public class ClassTablero 
{
    ...
    */
    int[][] casillas;
    public int ganador;
    public int[][] hcasillas = new hcasillas[7][7];
    ...
    public ClassTablero copia(){
        ClassTablero tcopia = new ClassTablero(tcopia);
         int a, b;
        for (a=0;a < 7; a++) {
            for (b=0;b < 7; b++) {
    ...
    public Boolean insertficha(int columna, int jugador){
        Boolean ok = false;
        int i;
        for ia=0;i < 7; i++) {
    ...
    public ArrayList<Integer> jugadasPosibles(){
        int columna;
