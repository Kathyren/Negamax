...
/**
 * this class provides an aggressive ai for the game "connect 4"
 */
public class AggressivePlayer extends ComputerPlayerMiniMax implements MyPlayerInterface {

    public AggressivePlayer(int width) {
        super(width);
